            ...
            <div className="w-full px-2 md:px-10 mx-auto">
              <h1 className="text-3xl font-bold mb-6 mt-6">
                ...
                <InfoIcon
                  ...
                  description="Consulta los lotes de ingreso de inventario, con información de producto, lote, cantidad, proveedor, stock y bodega/sucursal/negocio."
                />
              </h1>
