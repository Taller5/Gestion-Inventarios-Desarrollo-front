    ...
    <ProtectedRoute allowedRoles={["administrador"]}>
        ...
        <div className="flex">
             <div className="w-full pl-10 pt-10">
                <h1 className="text-2xl font-bold h-5">Bienvenido a Gestior, {user.name}
                    <InfoIcon
                        title="Inicio"
                ...
                <div className="grid grid-cols-4 grid-rows-3 gap-5">
                    ...
                    <div className="mt-10 max-h-[4rem]">
                        <a href="/businesses" className="rounded-lg border border-gris-ultra-claro flex flex-col p-4 justify-center max-h-[7rem] hover:scale-104 transition-transform hover:text-azul-medio">
                            <div className="w-full justify-center items-center flex">
                    ...
                    <div className="mt-10 max-h-[4rem]">
                        <a href="/inventory" className="rounded-lg border border-gris-ultra-claro flex flex-col p-4 justify-center max-h-[7rem] hover:scale-104 transition-transform hover:text-azul-medio">
                            <div className="w-full justify-center items-center flex">
