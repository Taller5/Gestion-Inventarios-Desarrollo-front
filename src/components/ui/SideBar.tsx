...
export default function SideBar(props: SideBarProps) {
    ...
    return (
        <section className="bg-azul-oscuro h-screen w-1/6">
            <div>
                
            </div>
            <article className="flex flex-col gap-15">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-15 w-15 pt-3 pl-6" viewBox="0 0 24 24" fill="currentColor">
                    ...
                    <div className=" w-full">
                        {props.button && props.button.map((button, index) => (
                            <div key={index} className="flex items-center gap-2 mb-3 w-full pl-6 hover:bg-azul-fuerte duration-300">
