...
return (
  <main className="w-full md:pl-1 pt-8">
    ...
    {!useCards ? (
      /* --------------------------------------------------
         TABLA RESPONSIVE (tablet / laptop)
      -------------------------------------------------- */
      <div className="w-full overflow-x-auto rounded-lg max-h-[500px] overflow-y-auto scrollbar-thin">
              ...
              props.tableContent?.map((row, rowIndex) => (
                ...
                >
                  {props.headers.map((header, colIndex) => (
                    <td
                      key={colIndex}
                      className="px-2 py-2 max-w-[140px] truncate break-words"
                    >
                      {header === "phone"
      ...
      /* --------------------------------------------------
         CARDS MOBILE / laptop muy pequeña
      -------------------------------------------------- */
